...
#ifndef CPIO_CLIENT_PROVIDERS_INSTANCE_CLIENT_PROVIDER_GCP_ERROR_CODES_H_
#define CPIO_CLIENT_PROVIDERS_INSTANCE_CLIENT_PROVIDER_GCP_ERROR_CODES_H_
...
DEFINE_ERROR_CODE(SC_GCP_INSTANCE_CLIENT_INSTANCE_INVALID_ARGUMENTS,
                  SC_GCP_INSTANCE_CLIENT_PROVIDER, 0x0007, "Missing arguments.",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)

DEFINE_ERROR_CODE(SC_GCP_INSTANCE_CLIENT_INVALID_INSTANCE_NAMESPACE_TYPE,
                  SC_GCP_INSTANCE_CLIENT_PROVIDER, 0x0008,
                  "Invalid instance namespace type.",
                  HttpStatusCode::INTERNAL_SERVER_ERROR)
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_INSTANCE_CLIENT_INVALID_INSTANCE_RESOURCE_TYPE,
                         SC_CPIO_CLOUD_INTERNAL_SERVICE_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_INSTANCE_CLIENT_INSTANCE_INVALID_ARGUMENTS,
                         SC_CPIO_CLOUD_INTERNAL_SERVICE_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_INSTANCE_CLIENT_INVALID_INSTANCE_NAMESPACE_TYPE,
                         SC_CPIO_CLOUD_INTERNAL_SERVICE_ERROR)
}  // namespace google::scp::core::errors

#endif  // CPIO_CLIENT_PROVIDERS_INSTANCE_CLIENT_PROVIDER_GCP_ERROR_CODES_H_
